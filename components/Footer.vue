<template>
    <div class="px-4 pt-8 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 border-t-2 mt-8">
      <div class="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
        <div class="md:max-w-md lg:col-span-2">
          <a href="/" aria-label="Go home" title="DocGeny" class="inline-flex items-center">
            ...
            <span class="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">DocGeny</span>
          </a>
      ...
      <div class="flex flex-col justify-between pt-5 pb-10 border-t sm:flex-row">
        <p class="text-sm text-gray-600">
          © Copyright {{ new Date().getFullYear() }} DocGeny
        </p>
